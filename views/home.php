...
<div class="education" id="education">
    ...
    <div class="col-md-6 skills">
        ...
        <div class="skill-agile">
            <div class='bar_group'>
                <div class='bar_group__bar thin elastic' label='HTML5 + Css3 + Js' value='250'></div>
                <div class='bar_group__bar thin elastic' label='JQuery' value='200'></div>
                <div class='bar_group__bar thin elastic' label='JAVA EE Orientação Objetos' value='320'></div>
                <div class='bar_group__bar thin elastic' label='Php | Mysql' value='340'></div>
                <div class='bar_group__bar thin elastic' label='IONIC | Cordova' value='180'></div>
            </div>
