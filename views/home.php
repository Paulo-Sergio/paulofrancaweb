  ...
  <div class="container">
	...
	<nav class="cl-effect-1" id="cl-effect-1">
	  <ul class="nav navbar-nav">
	    ...
	    <li><a href="#about" class="scroll hvr-bounce-to-bottom">Sobre</a></li>
  ...
  <div class="col-md-12 education-w3l">
	...
	<div class="education-agile-w3l">
	  ...
	  <div class="education-agile-w3l-info">
	    <h4>Formação curso superior</h4>
	    <p>Formado no curso superior de Sistemas de Informação. Lógica de Programação, JAVA EE, Banco de Dados, Analise de Requisitos...</p>
	  </div>
	  <div class="clearfix"></div>
	</div>
	<div class="education-agile-w3l two">
	  ...
	  <div class="education-agile-w3l-info">
	    ...
	    <p>Oferecido pelo(a) Instituto Tecnológico da Aeronáutica (ITA) em parceria com o Coursera...</p>
	  </div>
	  <div class="clearfix"></div>
	</div>
	<div class="education-agile-w3l">
	  ...
	  <div class="education-agile-w3l-info">
	    ...
	    <p>Oferecido pelo(a) Universidade de Ciência e Tecnologia de Hong Kong em parceria com o Coursera...</p>
	  </div>
	  <div class="clearfix"></div>
	</div>
      </div>
  ...
  <div class="col-md-12 education-w3l">
	...
	<div class="education-agile-w3l">
	  ...
	  <div class="education-agile-w3l-info">
	    ...
	    <p>Criação de Web Sites focado na area de Front-End.</p>
	  </div>
	  <div class="clearfix"></div>
	</div>
	<div class="education-agile-w3l two">
	  ...
	  <div class="education-agile-w3l-info">
	    ...
	    <p>Análise e Desenvolvimento de sistemas Web, principalmente em Java. Encontrar e resolver bugs fixes, desenvolver novas funcionalidades, etc...</p>
	  </div>
	  <div class="clearfix"></div>
	</div>
	<div class="education-agile-w3l">
	  ...
	  <div class="education-agile-w3l-info">
	    <h4>Desenvolvedor</h4>
	    <p>Análise e Desenvolvimento de sistemas Web. Desenvolver funcionalidades para sistemas utilizados na secretaria da fazenda (SEFAZ)</p>
	  </div>
	  <div class="clearfix"></div>
	</div>
      </div>
